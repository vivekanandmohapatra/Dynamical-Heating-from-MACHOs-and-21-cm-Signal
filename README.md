...
- Note that the kinetic energy of MACHOs originates from the baryon-dark matter relative velocity (v_bc).
- Furthermore, frictional force depends on the ratio v_bc/c_s, where c_s is the sound speed. Interestingly, this ratio remains subsonic before recombination; hence, the MACHOs enter the supersonic regime right after recombination, thus leaving little to no imprint on the CMB. This makes the dark ages 21-cm signal the most important probe for such dark matter candidates, providing a cosmological window free from astrophysical uncertainties.
